...
<div class="container right-panel-active">
	...
	<div class="container__form container--signup">
		<form name=form1 method="post"  action="/useraccount/save" class="form" id="form1">
			<h2 class="form__title">Create Account</h2>
			<input type="hidden" placeholder="AcNo" class="input" name="acc_num" />
           <input type="text" placeholder="Person Name" class="input" name="person_name" />
            <input type="number" placeholder="Mobile Number" class="input" name="mobile_num"/>
	...
	<div class="container__overlay">
		<div class="overlay">
			<div class="overlay__panel overlay--left">
				...
				<br/>
				<a href="/homepage"><button class="btn" id="signIn">HomePage</button></a>
			</div>
