            ...
            <table class="table">
                <tr class="table-header">
                    ...
                    <th class="cell">Delete</th>
                     <th class="cell">Transaction History</th>
...
<c:set var="count" value="${count+1}" scope="page" />
                <tr  class="active">
                    ...
                    <td>${user.balance}</td>
                    <td> <button ><a href="/useraccount/accdelete?acc_num=${user.acc_num}">Delete</a></button></td>
                    <td> <button ><a href="/userlogin/transactionhistory?acc_num=${user.acc_num}">Transaction History</a></button></td>
                </tr>
              </c:forEach>
