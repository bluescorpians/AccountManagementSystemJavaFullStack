...
<body bgcolor="#fcffff">
 ...
 --%>
  ...
  <div class="container">
      <h1>Request For Forget Password</h1>
      <div class="row">
          <div class="col-md-12">
              <table class="table">
  ...
  <c:set var="count" value="${count+1}" scope="page" />
                  <tr  class="active">
                      ...
                      <td>${user.mobile_num}</td>
                      <td>${user.balance}</td>
                      <td> <button ><a href="/admin/fpd/appr?acc_num=${user.acc_num}">Approve</a></button></td>
                      <td> <button ><a href="/admin/fpd/deny?acc_num=${user.acc_num}">Deny</a></button></td>
                  </tr>
                </c:forEach>
