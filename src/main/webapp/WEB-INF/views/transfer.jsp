...
<form action="/useraccount/transfer"  method="post">
<table width=100% align=center>
<tr> <td width=''50%''>
<table width=80% border=1 cellspacing=5 cellpadding=6>

<tr> <td colspan=2>Transfer Money </td> </tr>
<tr> <td > Enter YOUR Account Number </td> <td> <input type="text" name="acc_num1" id="acc_num1" > </td> </tr>
<tr> <td > Enter RECIPIENT's Account Number </td> <td> <input type="text" name="acc_num2" id="acc_num2" > </td> </tr>
...
<form action="/useraccount/deposit"  method="post">
<table width=100% align=center>
<tr> <td width=''50%''>
<table width=80% border=1 cellspacing=5 cellpadding=6>

<tr> <td colspan=2>Cash deposit </td> </tr>
...
<style>
  ...
  .checkbox label {
    ...
    <div id="login-page">
        <div class="login">
            <h2 class="login-title">Transfer Money</h2>
          <p class="notice"></p>
          <form class="form-login" action="/useraccount/transfer"  method="post">
            <label for="number">Enter Your A/C No.</label>
            <div class="input-email">
              <i class="fas fa-envelope icon"></i>
              <input type="number" name="acc_num1" placeholder="Enter your A/C No." >
            </div>
              <label for="number">Enter Receivers A/C No.</label>
            <div class="input-email">
              <i class="fas fa-envelope icon"></i>
              <input type="number" name="acc_num2" placeholder="Enter Receivers A/C No." >
            </div>
            ...
            <button type="submit"><i class="fas fa-door-open"></i>Transfer</button>
          </form>
