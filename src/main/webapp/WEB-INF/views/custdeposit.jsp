...
<style>
  ...
  .checkbox label {
    ...
    <div id="login-page">
        <div class="login">
            <h2 class="login-title">Cash Deposit</h2>
          <p class="notice"></p>
          <form class="form-login" action="/useraccount/deposit"  method="post">
            <label for="number">Enter A/C No.</label>
            <div class="input-email">
              <i class="fas fa-envelope icon"></i>
              <input type="number" name="anum" placeholder="Enter your AC/No" >
            </div>
            ...
            <button type="submit"><i class="fas fa-door-open"></i>Deposit</button>
          </form>
